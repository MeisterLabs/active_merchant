  ...
  module Billing
    ...
    class PaypalNotification
      ...
      def acknowledge(authcode = nil)
        payload =  raw
        redirect_url = test? ? 'https://www.sandbox.paypal.com/cgi-bin/webscr' : 'https://www.paypal.com/cgi-bin/webscr'

        response = ssl_post(redirect_url + '?cmd=_notify-validate', payload,
